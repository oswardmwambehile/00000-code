...
class Branch(models.Model):
    ...
    created_at = models.DateTimeField(auto_now_add=True, null=True, blank=True)  # set once on creation
    updated_at = models.DateTimeField(auto_now=True, null=True, blank=True)      # update every save
